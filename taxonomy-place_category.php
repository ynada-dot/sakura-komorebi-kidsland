...
<div class="single-introduction">
            ...
            <section>
                <div class="page-introduction taxonomy__place_category">
                    <div class="letter__tti-area">
                        <div class="welcom__logo">
                            <img loading="lazy" class="welcom__logo--img" src="<?php echo get_template_directory_uri(); ?>/img/section-heading2__icon.webp" alt="各セクションのアイコン" width="108" height="108">
                        </div>
                    </div>
                        ...
                        <div id="daycare" class="daycare">
                            ...
                            <?php
                                ...
                                foreach ($terms as $term) {
                                    $class = 'daycare__cat--link';
                                    if ($term->term_id == $current_term_id) {
                                        $class .= ' select_back-color'; 
                                    }
                                    echo '<li class="daycare__cat--item fadeUpTarget">';
                                    echo '<a class="' . $class . '" href="' . get_term_link($term) . '">' . $term->name . '</a>';
                                    echo '</li>';
                                }
                                ?>
                                            ...
                                            <li class="daycare__list fadeUpTarget" style="background-color: <?php echo $background_color; ?>;">
                                                ...
                                                <?php
                                                    ...
                                                    if (has_post_thumbnail()) {
                                                        the_post_thumbnail('full', array('class' => 'daycare__list--img', 'loading' => 'lazy', 'alt' => get_the_title()));
                                                    }
                                                    ...
                                                    if ($custom_img_id) {
                                                        ...
                                                        echo wp_get_attachment_image($custom_img_id, 'full', false, array('class' => 'daycare__list--img', 'loading' => 'lazy', 'alt' => esc_attr($custom_img_alt)));
                                                    } else {
