...
<section>
    ...
    <div class="archive-post__body">
        <div class="archive-post__cate">
         ...
         echo '<a class="archive-post__cate--txt fadeUpTarget" href="' . get_post_type_archive_link('information') . '" data-term-id="all">すべて</a>';
            foreach ($terms as $term) {
                $term_link = esc_url(get_term_link($term));
                $term_name = esc_html($term->name);
                echo '<a class="archive-post__cate--txt fadeUpTarget" href="' . $term_link . '" data-term-id="' . $term->term_id . '">' . $term_name . '</a>';
            }
            ?>
        </div>
                    ...
                    <a class="archive-post__item" href="<?php echo esc_url(get_permalink()); ?>">
                        <div class="archive-post__item--left" style="background-color: <?php echo esc_attr($info_color); ?>;">
                            ...
                            if (has_post_thumbnail()) {
                                the_post_thumbnail('full', array('class' => 'archive-post__left--img', 'loading' => 'lazy'));
                            }
