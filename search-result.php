        ...
        <div class="archive-letter__body-area">
            ...
            <div class="archive-letter__list">
                <ul class="archive-letter__list-area">
                    ...
                    if (isset($_GET['letter_each-place'])) {
                        $tax_query[] = array(
                            'taxonomy' => 'letter_each-place',
                            'field'    => 'slug',
                            'terms'    => sanitize_text_field($_GET['letter_each-place']),
                        );
                    }

                    if (isset($_GET['school_name'])) {
                        $tax_query[] = array(
                            'taxonomy' => 'school_name',
                            'field'    => 'slug',
                            'terms'    => sanitize_text_field($_GET['school_name']),
                        );
                    }
