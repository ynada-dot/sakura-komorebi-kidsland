                ...
                <div class="page__ttl-area">
                    <div class="page__ttl-area--area">
                        ...
                        <div class="page__ttl-are--txta-area">
                            <h1 class="page__ttl-are--ttl fadeUpTarget">サイトマップ</h1>
                            <p class="page__ttl-are--en fadeUpTarget">Sitemap</p>
                        </div>
                    </div>
                    ...
                    <div class="site-map__body">
                        <div class="site-map__left">
                            ...
                            <ul class="site-map__list">
                                ...
                                <li class="site-map__item fadeUpTarget">
                                    <a class="site-map__item--link" href="<?php echo esc_url(home_url('/contact')); ?>">お問い合わせ</a>
                                </li>
                                <li class="site-map__item fadeUpTarget">
